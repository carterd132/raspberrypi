...
default_args = {
 ...
 'solutionname': 'cybersecuritywithprivategpt-28fb',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_cybersecuritywithprivategpt-28fb", default_args=default_args, tags=["tml_system_step_1_getparams_dag_cybersecuritywithprivategpt-28fb"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
